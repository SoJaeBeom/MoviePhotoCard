...
function listing(id) {
    $.ajax({
        ...
        success: function (response) {
            let result = response['movies']
            let img = result['movie_img']
            let name = result['movie_name']

            $('#movie_name').val(name)

            let temp_img = `<img id="movie_img" src="${img}" alt="...">`
            $('#movie_img_container').append(temp_img)
        }
    });
}
